...
Ridge_reg$grid <- function(x, y, len = NULL, search = "grid"){
  data.frame(lambda=c(0.1,0.6,0.8,1,1.5,2))
}
...
From the result section, the 10 fold cross validation produces MAE between 3.633 to 3.65. and the original ridege_fit produces MAE of 3.66 to 3.69. Therefore we can conclude that the linear model(lm) is the best performed model.