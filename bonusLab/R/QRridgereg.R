#' A reference class to perform ridge regression with QR decomposition.
#' 
#' @import methods
...
#' @export QRridgereg
#' @exportClass QRridgereg
QRridgereg <- setRefClass("QRridgereg", 
                          ...
                          methods = list(
                            ...
                            initialize = function(formula, data, lambda) {
                              ...
                              b_ridge <<- solve(t(R) %*% R + lambda * I) %*% t(X) %*% y 
